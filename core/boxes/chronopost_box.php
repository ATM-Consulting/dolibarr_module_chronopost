 ...
 */
class chronopostbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "chronopost@chronopost";
    public $boxlabel;
    public $depends = array("chronopost");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/chronopost/class/chronopost.class.php";
